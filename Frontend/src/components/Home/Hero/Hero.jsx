...
const sareeData = {
  ...
  description:
    "Elevate your ethnic wardrobe with our stunning Silk Saree, a timeless addition for your special occasions.",
  features: [
          ...
          <div className="saree-container">
            <div className="saree-text">
              ...
              <div className="buttons">
                <p className="prices">BEST PRICE: {item.price}</p>
                <button className="btns white">LEARN MORE</button>
                <button className="btns black">ADD TO CART</button>
              </div>
            </div>
